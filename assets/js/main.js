...
$(document).ready(function() {
	...
	burger_menu = $('.navbar').hasClass('navbar-burger') ? !0 : !1;
	if (!Modernizr.touch) {
...
$('a[data-scroll="true"]').click(function(e) {
	...
	if (scroll_trigger == !0 && scroll_target !== undefined) {
		e.preventDefault();
		$('html, body').animate(
...
var better_browser = `<div class="container">
<div class="better-browser row">
    ...
    <div class="col-md-4">
        <a href="https://www.google.com/chrome/browser/desktop/index.html" class="btn ">Chrome</a>
        <br>
    </div>
    <div class="col-md-12">
        <br>
